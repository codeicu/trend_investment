...
public class IndexDataController {
    ...
    public String fresh(@PathVariable("code") String code) throws Exception {
        List<IndexData> indexDatas=indexDataService.fresh(code);
        if(indexDatas.size()>1) return "fresh index data successfully";
        else return  "third part index service not connected";
    }
